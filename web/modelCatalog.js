...
export const modelChoices=[
 ...
 ...(manifest.models.tiger?[{id:'tiger',title:'Tiger pose',description:'Explore a 12-point tiger pose prototype.',hint:'New training on frames from one tiger video. Landmarks are approximate; generalization to other animals or scenes is unproven. Try a validation example or upload a tiger photo.',...manifest.models.tiger}]:[]),
];
