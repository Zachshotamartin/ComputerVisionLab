...
export const modelChoices=[
 ...
 {id:'oct',title:'Retinal OCT',description:'Explore the archived four-class retinal-scan classifier.',hint:'Research demo, not a diagnostic tool. Use retinal OCT scans; ordinary photos are outside its training.',...manifest.models.oct},
...
export const classLabel=value=>({shine:'Shine',cloudy:'Cloudy',rain:'Rain',sunrise:'Sunrise',empty:'Empty',not_empty:'Occupied',NORMAL:'Normal',alpaca:'Alpaca'}[value]||value);
