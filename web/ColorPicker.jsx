...
export default function ColorPicker({ value, onChange }) {
  ...
  return <fieldset className="vision-color-picker">
    ...
    <div className="vision-color-value">
    ...
    <p id={`${id}-help`} className="vision-color-help">{invalid ? 'Enter a six-digit hex color, such as #35b8a3.' : saturation < .15 ? 'Black, white, and gray have no hue. Choose a colored target.' : 'Drag the hue slider, choose a swatch, or enter a hex color.'}</p>
  </fieldset>;
}
